        ...
        >
            {!pet ? (
                ...
                <div className="w-full h-90% relative group">
                    ...
                    {/* ------ FRONT CARD ----- */}
                    <div className="transform transition-transform duration-500 ease-in-out w-full h-full rotate-y-0 laptop:group-hover:rotate-y-180 p-2 backface-hidden !bg-no-repeat !bg-cover !bg-center absolute top-0 left-0 rounded-lg overflow-hidden shadow-md bg-gray-200">
                        <Image
            ...
            {!pet ? (
                <Skeleton width={'40%'} height={15} className="my-2" />
            ) : (
